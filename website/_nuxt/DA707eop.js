import{J as m,_ as L,r as T,m as A,h as O,D as j,c as v,o as c,a as t,b as x,N as b,O as w,C as k,w as C,H as _,T as M}from"./D0RqSmMK.js";/**
 * @license lucide-vue-next v0.509.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B=s=>s.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),z=s=>s.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,a,o)=>o?o.toUpperCase():a.toLowerCase()),H=s=>{const e=z(s);return e.charAt(0).toUpperCase()+e.slice(1)},I=(...s)=>s.filter((e,a,o)=>!!e&&e.trim()!==""&&o.indexOf(e)===a).join(" ").trim();/**
 * @license lucide-vue-next v0.509.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N=({size:s,strokeWidth:e=2,absoluteStrokeWidth:a,color:o,iconNode:d,name:i,class:f,...h},{slots:l})=>m("svg",{...g,width:s||g.width,height:s||g.height,stroke:o||g.stroke,"stroke-width":a?Number(e)*24/Number(s):e,class:I("lucide",...i?[`lucide-${B(H(i))}-icon`,`lucide-${B(i)}`]:["lucide-icon"]),...h},[...d.map(u=>m(...u)),...l.default?[l.default()]:[]]);/**
 * @license lucide-vue-next v0.509.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E=(s,e)=>(a,{slots:o})=>m(N,{...a,iconNode:e,name:s},o);/**
 * @license lucide-vue-next v0.509.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
